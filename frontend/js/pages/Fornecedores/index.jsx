...
export const Fornecedores = () => {
    ...
    const [dadoFornecedor, setdadoFornecedor] = useState();
    ...
    return (<LayoutBasePagina renderTabela titulo="Cadastro de Fornecedores" subTitulo="Gerenciamento de Fornecedores" totalElements={(totalElements >= 0 && totalElements < 3 ? 32 : 62) || (totalElements > 5 ? 65 : 65)} barraFerramentas={<BarraFerramentas textoBotaoNovo="NOVO FORNECEDOR" mostrarInputBusca mostrarBotaoNovo textoDaBusca={busca} aoClicarEmNovo={handleOpen} aoMudarTextoDeBusca={texto => setSearchParams({ busca: texto, pagina: '1', paginaAPI: '0' }, { replace: true })}/>}>
            <TableContainer sx={{ height: "500px", margin: 1 }}>
                <Table>
                    ...
                    <TableBody>
                        {rows.map(row => (<TableRow key={row.idFornecedor}>
                                ...
                                <TableCell width={200}>
                                    <Button variant="contained" color="warning" disableElevation onClick={() => { handleOpenEdit(); getFornecedorById(row.idFornecedor); }} sx={{
                marginRight: theme.spacing(1),
            }}>
                                        Editar
                                    </Button>
                                    <Button variant="contained" color="error" disableElevation onClick={() => { handleDelete(row.idFornecedor); }}>
                                        Deletar
                                    </Button>
                                </TableCell>
                            </TableRow>))}
                ...
                <Box margin={1} display="flex" flexDirection="column">
                        <Grid container direction="column" padding={2} spacing={2}>
                            ...
                            <Grid container item direction="row" spacing={1}>
                                ...
                                <Grid item md={12}>
                                    <VTextField name="name" label="Fornecedor" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
                                ...
                                <Grid item md={6}>
                                    <VInputMask tipoMask="CNPJ" name="cnpj" label="CNPJ/CPF" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
                                ...
                                <Grid item md={6}>
                                    <VTextField name="email" label="E-mail" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
                            ...
                            <Grid container item direction="row" spacing={1}>
                                <Grid item md={6}>
                                    <VInputMask tipoMask="TELEFONE" name="phoneNumber" label="Contato" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
                                ...
                                <Grid item md={6}>
                                    <VInputMask tipoMask="CEP" name="Endereco.cep" label="CEP" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
        ...
        }} onBlur={(e) => { consultaCEP(e.currentTarget.value); }} error={erroCEP} helperText={erroCEP && "CEP Inválido"} onKeyDown={(_) => setErroCEP(false)} fullWidth/>
                                </Grid>
                            ...
                            <Grid container item direction="row" spacing={2}>
                                ...
                                <Grid item md={6}>
                                    <VTextField disabled name="Endereco.logradouro" label="Endereço" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
                                ...
                                <Grid item md={6}>
                                    <VTextField name="Endereco.numero" label="Número" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
                            ...
                            <Grid container item direction="row" spacing={2}>
                                ...
                                <Grid item md={3}>
                                    <VTextField disabled name="Endereco.cidade" label="Cidade" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
                                ...
                                <Grid item md={3}>
                                    <VTextField disabled name="Endereco.estado" label="Estado" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
                                ...
                                <Grid item md={6}>
                                    <VTextField name="Endereco.complemento" label="Complemento" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
            ...
            <ModalCadastro open={openModalEdit} handleClose={handleCloseEdit} formSubmit={save} titulo="Editar Fornecedor" tituloButtonEdit="Salvar Fornecedor" edit={openModalEdit}>
