...
export const Usuarios = () => {
    ...
    return (<LayoutBasePagina renderTabela titulo="Cadastro de Usuários" subTitulo="Gerenciamento de Usuários" totalElements={(totalElements >= 0 && totalElements < 3 ? 32 : 62) || (totalElements > 5 ? 65 : 65)} barraFerramentas={<BarraFerramentas textoBotaoNovo="NOVO USUÁRIO" mostrarInputBusca mostrarBotaoNovo textoDaBusca={busca} aoClicarEmNovo={handleOpen} aoMudarTextoDeBusca={texto => setSearchParams({ busca: texto, pagina: '1', paginaAPI: '0' }, { replace: true })}/>}>
            <TableContainer sx={{ height: "500px", margin: 1 }}>
                <Table>
                    ...
                    <TableBody>
                        {rows.map(row => (<TableRow key={row.idUsuario}>
                                ...
                                <TableCell width={200}>
                                    <Button variant="contained" color="warning" disableElevation onClick={() => { handleOpenEdit(); getUsuarioById(row.idUsuario); }} sx={{
                marginRight: theme.spacing(1),
            }}>
                                        Editar
                                    </Button>
    
                                    <Button variant="contained" color="error" disableElevation onClick={() => { handleDelete(row.idUsuario); }}>
                                        Deletar
                                    </Button>
                                </TableCell>
                            </TableRow>))}
            ...
            <ModalCadastro open={openModal} handleClose={handleClose} formSubmit={save} titulo="Adicionar Novo Usuário" tituloButtonAdd="Adicionar Usuário">
                        ...
                        <Grid container direction="column" padding={2} spacing={2}>
                            ...
                            <Grid container item direction="row" spacing={2}>
                                ...
                                <Grid item md={12}>
                                    ...
                                    <VTextField name="name" label="Nome Completo" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
                            ...
                            <Grid container item direction="row" spacing={2}>
                                ...
                                <Grid item md={6}>
                                    ...
                                    <VTextField name="email" label="E-mail" variant="outlined" type="email" fullWidth/>
                                </Grid>
            ...
            <ModalCadastro open={openModalEdit} handleClose={handleCloseEdit} formSubmit={save} titulo="Editar Usuário" tituloButtonEdit="Salvar Usuário" edit={openModalEdit}>
                ...
                paddingRight: 0
                            ...
                            <Grid container item direction="row" spacing={2}>
                                ...
                                <Grid item md={6}>
                                    ...
                                    <VTextField disabled name="password" label="Senha" variant="outlined" type="password" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
