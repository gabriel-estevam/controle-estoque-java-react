...
import { Table, TableBody, TableCell, TableHead, TableRow, Box, Grid, Alert, AlertTitle, Collapse, IconButton, Button } from '@mui/material';
...
export const Recebimento = () => {
    ...
    return (<LayoutBasePagina renderTabela titulo="Recebimento de Materiais" subTitulo="Materiais Solicitados" barraFerramentas={<BarraFerramentas mostrarBotaoNovo={false} textoDaBusca={busca} aoMudarTextoDeBusca={texto => setSearchParams({ busca: texto, pagina: '1', paginaAPI: '0' }, { replace: true })}/>}>
            ...
            <ModalCadastro open={openModalEdit} handleClose={handleCloseEdit} formSubmit={save} titulo="Recebimento de Materiais" tituloButtonEdit="Confirmar Recebimento" edit={openModalEdit}>
                    ...
                    <Box margin={1} display="flex" flexDirection="column">
                        ...
                        <Grid container direction="column" padding={2} spacing={2}>
                            ...
                            <Grid container item direction="row" spacing={1}>
                                ...
                                <Grid item md={2}>
                                    <VTextField name="numeroSol" label="Solicitação" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
            ...
            "& input": { border: 'none',
                ...
                paddingRight: 0
                                ...
                                <Grid item md={2}>
                                    <VTextField name="notaEntrada" label="Nota.Entrada" variant="outlined" type="number" fullWidth/>
                                </Grid>

                                <Grid item md={3}>
                                    <VDateTimeField name="dataEntrada" variant="outlined" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
