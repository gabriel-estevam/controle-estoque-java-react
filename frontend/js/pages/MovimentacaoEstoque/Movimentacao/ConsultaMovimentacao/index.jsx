...
import { LinearProgress, Pagination, Table, TableBody, TableCell, TableFooter, TableHead, TableRow } from '@mui/material';
...
export const ConsultaEstoque = () => {
    ...
    return (<LayoutBasePagina renderTabela titulo="Consultar Movimentação de Estoque" subTitulo="Materiais Saida Estoque" totalElements={(totalElements >= 0 && totalElements < 3 ? 32 : 62) || (totalElements > 5 ? 65 : 65)} barraFerramentas={<BarraFerramentas mostrarInputBusca mostrarBotaoNovo={false} textoDaBusca={busca} aoMudarTextoDeBusca={texto => setSearchParams({ busca: texto, pagina: '1', paginaAPI: '0' }, { replace: true })}/>}>
