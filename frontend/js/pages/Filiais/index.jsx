...
export const Filiais = () => {
    ...
    const [dadoFilial, setdadoFilial] = useState();
    ...
    return (<LayoutBasePagina renderTabela titulo="Cadastro de Filiais" subTitulo="Gerenciamento de Filiais" totalElements={(totalElements >= 0 && totalElements < 3 ? 32 : 62) || (totalElements > 5 ? 65 : 65)} barraFerramentas={<BarraFerramentas textoBotaoNovo="NOVA FILIAL" mostrarInputBusca mostrarBotaoNovo textoDaBusca={busca} aoClicarEmNovo={handleOpen} aoMudarTextoDeBusca={texto => setSearchParams({ busca: texto, pagina: '1', paginaAPI: '0' }, { replace: true })}/>}>
            <TableContainer sx={{ height: "500px", margin: 1 }}>
                <Table>
                    ...
                    <TableBody>
                        {rows.map(row => (<TableRow key={row.idFilial}>
                                ...
                                <TableCell width={200}>
                                    <Button variant="contained" color="warning" disableElevation onClick={() => { handleOpenEdit(); getFilialById(row.idFilial); }} sx={{
            ...
            <ModalCadastro open={openModal} handleClose={handleClose} formSubmit={save} titulo="Adicionar Nova Filial" tituloButtonAdd="Adicionar Filial" tituloButtonEdit="Salvar Filial">
                    ...
                    <Box margin={1} display="flex" flexDirection="column">
                        ...
                        <Grid container direction="column" padding={2} spacing={2}>
                            ...
                            <Grid container item direction="row" spacing={1}>
                                ...
                                <Grid item md={6}>
                                    <VTextField name="name" label="Nome Filial" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
                paddingRight: 0
                                ...
                                <Grid item md={6}>
                                    <VInputMask tipoMask="CNPJ" name="cnpj" label="CNPJ" variant="outlined" type="text" sx={{
            "& input": { border: 'none',
                margin: 2,
                padding: 1,
                paddingY: 0,
            ...
            <ModalCadastro open={openModalEdit} handleClose={handleCloseEdit} formSubmit={save} titulo="Editar Filial" tituloButtonAdd="Adicionar Filial" tituloButtonEdit="Salvar Filial" edit={openModalEdit}>
