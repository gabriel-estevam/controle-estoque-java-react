...
export const RelatorioProdutos = () => {
    ...
    return (<LayoutBasePagina renderTabela={false} titulo="Relatório de Produtos" relatorios={true} barraFerramentas={<BarraFerramentas textoBotaoNovo="Gerar Relatório" mostrarInputBusca={false} mostrarBotaoNovo aoClicarEmNovo={() => { gerarRelatorio(); }}/>}> 
        </LayoutBasePagina>);
};
